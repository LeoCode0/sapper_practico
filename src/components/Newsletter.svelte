...
<div class="Newsletter">
  <h4>NEWSLETTER</h4>
  <p>
    Recibe las ultimas novedades acerca de Frontend Development en tu correo
  </p>
  <form
    style="border:1px solid #ccc;padding:3px;text-align:center;"
    action="https://tinyletter.com/LeoCode0"
    method="post"
    target="popupwindow"
    onsubmit="window.open('https://tinyletter.com/LeoCode0', 'popupwindow',
    'scrollbars=yes,width=800,height=600');return true">
    <p>
      <label for="tlemail">Ingresa tu Email</label>
    </p>
    <p>
